...
2. get_exchange_rate 결과의 trend 값에 따라 아래 규칙을 반드시 준수할 것:
   - trend가 "원화 강세" 또는 "원화 매우 강세"인 경우:
     - body에 아래 예시와 같은 구체적인 문장을 반드시 한 문장 이상 포함할 것:
       · "환율이 좋아서 현지 먹거리나 기념품 사기도 전혀 부담 없어🛍️"
       · "지금 환율 덕분에 현지 쇼핑까지 여유롭게 즐길 수 있어"
       · "요즘 환율이 좋아서 현지에서 지갑 열기도 부담 없다고🍽️"
     - 예시 문장을 그대로 복사하지 말고 여행지·상품 맥락에 맞게 변형할 것
     - "원화 강세", "원화 매우 강세" 표현을 body에 직접 사용하지 말 것
   - trend가 "보통" 또는 "원화 약세"인 경우:
     - 환율 관련 내용은 일절 언급하지 말 것
